...
| 配图 | 1-3 张 SVG | 6-12 张（架构图、流程图、对比图、数据图） |
| 代码 | 偶尔 | 少量关键片段（用于说明，不追求大段实现） |
...
- **总字数**：3000-6000 字
- **代码行数**：20-80 行（聚焦关键逻辑，避免大段贴代码）
- **H2 章节**：5-8 个
- **配图**：6-12 张
- **阅读时间**：10-20 分钟
- **节奏感**：每 300-400 字至少有一个视觉元素（优先图片/图表）
