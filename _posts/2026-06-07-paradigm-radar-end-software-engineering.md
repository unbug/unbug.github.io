...
![传统软件工程 vs Agentic 系统的核心差异]({{ site.baseurl }}/assets/images/paradigm-radar-end-software-engineering.svg)
...
![复杂度转移的三条曲线]({{ site.baseurl }}/assets/images/paradigm-radar-end-software-engineering-complexity.svg)
