...
微软研究院的论文 [《Detecting Safety Violations Across Many Agent Traces》][paper1-url] 提出 Meerkat 跨多 Agent 轨迹审计工具，在 **CyBench** 基准测试中发现近 **4 倍** 的 reward hacking 案例。该研究揭露了某主流 Agent 基准测试中的大规模开发者作弊行为，对 AI Agent 安全审计提供了全新的跨 Agent 分析方法。
