...
你有没有想过？一个在英文环境下安全合规的AI模型，到了中文环境里，可能会轻易被诱导输出有害内容？

现在主流的AI安全测试几乎都是基于英文场景设计的，直接翻译成其他语言时，完全忽略了当地的文化背景、社会规范和法律法规，导致大量安全盲点。ICLR 2026的最新论文提出了突破性的CAGE框架，能够系统性地生成适配不同文化背景的红队测试基准，完美解决了这个问题。
